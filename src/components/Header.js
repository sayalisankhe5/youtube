...
const Header = () => {
  ...
  const getSearchSuggestions = async () => {
    ...
    dispatch(cacheResults({ [searchQuery]: ["hi", "hell"] }));
  };
  ...
  return (
    <div className="grid grid-flow-col p-2 m-2 shadow-lg">
      <div className="flex col-span-1">
        <img
          className="h-6 h- cursor-pointer"
      ...
      <div className="col-span-10">
        <div className="w-1/2 mx-auto">
          <input
            className="rounded-l-full border border-gray-400 w-4/5 px-5 py-2"
            type="search"
            value={searchQuery}
          ...
          ></input>
          <button className="rounded-r-full border-gray-400 border bg-gray-100 px-5 py-2">
            Search
          </button>
        </div>

        {showSuggestions && (
          <div className="fixed rounded-md p-2 bg-white border ml-72 w-[30%]">
            <ul>
              <li className="hover:bg-gray-100">iphone</li>
              <li>iphone pr</li>
              <li>iphone pro </li>
